...
import com.nx.mybatis.core.enums.SqlConstants;
import com.nx.datasource.jdbc.JdbcUtils;
...
public class IdTypeEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    private static final Set<DbType> INPUT_ID_TYPES = asSet(DbType.ORACLE, DbType.ORACLE_12C,DbType.POSTGRE_SQL, DbType.KINGBASE_ES, DbType.DB2, DbType.H2);
