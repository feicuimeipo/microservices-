...
/**
 * <b>@Title: CloudPlatformMetricsEndpoint;<T> </b>
 * <p>@Description: 云平台自定义度量指标端点</p>
 * <p>1. </p>
 ...
 * http://localhost:8013/management/metrics/CloudPlatform
 */
@Slf4j
...
public class MetricsEndpoint {
    ...
    /**
     * <p>Constructor for CloudNativeMetricsEndpoint.</p>
     *
    ...
    private Map<String, Map<String, Number>> databaseMetrics() {
        ...
        //Collection<Timer> timers = Search.in(this.meterRegistry).name(s -> s.contains("druid")).timers();
        timers.forEach(timer -> {
