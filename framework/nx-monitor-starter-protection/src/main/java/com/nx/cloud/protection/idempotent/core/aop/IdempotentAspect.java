package com.nx.cloud.protection.idempotent.core.aop;


import com.nx.cloud.protection.idempotent.core.annotation.Idempotent;
...
public class IdempotentAspect {
    ...
    public IdempotentAspect(List<IdempotentKeyResolver> keyResolvers, IdempotentRedisDAO idempotentRedisDAO) {
        ...
        if (keyResolvers!=null){
           keyResolvers.stream().forEach(item->{
               this.keyResolvers.put(item.getClass(),item);
           });
        }
    ...
    public void beforePointCut(JoinPoint joinPoint, Idempotent idempotent) {
        ...
        if (!success) {
            ...
            throw new ServiceException(ResultCode.REPEATED_REQUESTS.getCode(), idempotent.message());
        }
    }
