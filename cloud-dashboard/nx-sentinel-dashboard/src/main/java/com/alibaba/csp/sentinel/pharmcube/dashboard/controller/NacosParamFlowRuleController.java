 ...
 */
package com.alibaba.csp.sentinel.pharmcube.dashboard.controller;
...
public class NacosParamFlowRuleController {

    private final Logger logger = LoggerFactory.getLogger(NacosParamFlowRuleController.class);
