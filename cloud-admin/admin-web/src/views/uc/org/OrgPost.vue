  ...
  <div class="fullheight">
    <ht-table
      ...
      <template v-slot:toolbar>
        <el-button-group>
          <el-button size="small" @click="showDialog()" icon="el-icon-plus">添加岗位</el-button>
          <ht-delete-button
              :url="demDeleteUrl"
      ...
      <template>
        ...
        >
          <template v-slot="{row,column,$index}">
            <el-link type="primary"  @click="handleCommand({row:row,command:'edit'})" title="点击编辑" >{{row.name}}</el-link>
          </template>
        </ht-table-column>
    ...
    <ht-sidebar-dialog
        ...
        :append-to-body="true"
    >
      <el-form v-model="OrgPost" data-vv-scope="editForm"  :label-position="position">
    ...
    <ht-sidebar-dialog
        ...
        :append-to-body="true"
    >
      <el-form v-model="OrgPost"  :label-position="position" data-vv-scope="editDemForm">
        <ht-form-item label="岗位名称" prop="code" label-width="100px">
          <ht-input
              v-model="OrgPost.name"
              autocomplete="off"
