            ...
            <ht-table-column width="150">
              ...
              <template v-slot="{ row }">
                <el-dropdown
                  ...
                  "
                >
                  <span> <i class="el-icon-user"></i>下属管理 </span>
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item
                      icon="el-icon-s-comment"
                      :command="{ row: row, command: 'setIsMaster' }"
                      v-if="row.isMaster == '0'"
                      >设置主组织</el-dropdown-item
                    >
                    <el-dropdown-item
                      icon="el-icon-s-comment"
                      :command="{ row: row, command: 'setIsMaster' }"
                      v-if="row.isMaster == '1'"
                      >取消主组织</el-dropdown-item
                    >
                    <el-dropdown-item
                      icon="el-icon-s-home"
...
import underUserTable from  "@/views/uc/heiorgmanager/UnderUserTable.vue";
