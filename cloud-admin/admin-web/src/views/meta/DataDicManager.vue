<template>
  <el-container class="fullheight" style="border: 1px solid #eee">
    <div>
      ...
      <!-- 导入 -->
      <el-dialog :visible.sync="dialogImportVisible" title="导入" width="50%">
      ...
      >
        <el-form :model="sysType" data-vv-scope="editSysTypeForm">
          ...
          <ht-form-item label="分类名称" label-width="100px">
            <ht-input v-model="sysType.name" autocomplete="off" validate="required"></ht-input>
          </ht-form-item>
      ...
      >
        <el-form :model="dicData" data-vv-scope="editDic">
          <ht-form-item label="项名称" label-width="80px">
            <ht-input v-model="dicData.name" autocomplete="off" validate="required"></ht-input>
          </ht-form-item>
...
export default {
  ...
  methods: {
    ...
    //下载模板
    downloadTemplate(){
      window.location.href = '/static/excel/数据字典模板.xls';
    }
  }
};
</script>
