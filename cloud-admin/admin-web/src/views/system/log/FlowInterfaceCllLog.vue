...
export default {
  ...
  methods: {
    ...
    loadData(param, cb) {
      req
        .post(
          req.getContext().bpmRunTime + "/runtime/bpmCallLog/v1/list",
          param
        )
        .then(data => {
    ...
    reinvoke(id) {
      let this_ = this;
      req
        .post(req.getContext().bpmRunTime + "/runtime/bpmCallLog/v1/reinvoke/" + id)
    ...
    signSuccess(id) {
      ...
      req
        .post(
          req.getContext().bpmRunTime + "/runtime/bpmCallLog/v1/signSuccess/" + id
        )
        .then(function(response) {
          let data = response.data;
          if (data.state) {
