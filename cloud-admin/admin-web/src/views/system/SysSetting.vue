            ...
            <table class="form-table" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <ht-input v-model="sysSettingData.manageName" class="ht" placeholder="请输入系统管理端名称" autocomplete="off"></ht-input>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <ht-input v-model="sysSettingData.frontName" class="ht" placeholder="请输入系统应用端名称" autocomplete="off"></ht-input>
                        </td>
                    </tr>
                    <tr>
...
export default {
    ...
    methods: {
        ...
        init(){
            ...
            portal.getSysPropertyByAlias("sysSetting").then(response => {
