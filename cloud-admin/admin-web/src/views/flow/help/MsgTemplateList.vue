        ...
        <el-row>
          <el-col>
            <ht-form-item label="模板名称" label-width="120px">
              <ht-input v-model="formData.name" :validate="{ required: true }" />
            </ht-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col>
            <ht-form-item label="模版业务键" label-width="120px">
              <ht-input v-model="formData.key" :validate="{ required: true }" />
            </ht-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col>
            <ht-form-item label="短信模板ID" label-width="120px">
              <ht-input v-model="formData.smsTemplateNo" />
            </ht-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col>
            <ht-form-item label="语音模板ID" label-width="120px">
              <ht-input v-model="formData.voiceTemplateNo" />
            </ht-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col>
            <ht-form-item label="模版体HTML" label-width="120px">
              <htEditor v-model="formData.html"></htEditor>
            </ht-form-item>
          </el-col>
        </el-row>
      </el-form>
