    ...
    >
      <form data-vv-scope="confForm" v-form>
                  ...
                  <el-table :data="selectContent" border>
                    <el-table-column label="值">
                      <template slot-scope="scope">
                        <ht-input v-model="scope.row.optionKey" />
                      </template>
                    </el-table-column>
                    <el-table-column label="选项">
                      <template slot-scope="scope">
                        <ht-input v-model="scope.row.optionValue" />
                      </template>
                    </el-table-column>
        ...
        <template v-if="type==='B'">
          ...
          <br />
          <ht-input type="textarea" v-model="field.formater" />
        </template>
          ...
          <table class="form-table" style="width: 100%">
            <tbody>
              ...
              <tr>
                <th>配置</th>
                <td colspan="3">
                  <ht-input type="textarea" v-model="field.resultFrom" />
                </td>
              </tr>
            </tbody>
          </table>
