...
const dataTemplateList = () =>
  import("@/views/form/dataTemplate/DataTemplateManager.vue");
...
const sysTypeTreeManager = () =>
  import("@/views/system/SysTypeTreeManager.vue");
...
const flowInterfaceCllLog = () =>
  import("@/views/system/log/FlowInterfaceCllLog.vue");
...
const layoutDistribution = () =>
  import("@/views/portal/LayoutDistribution.vue");
...
const sysSetting = () =>
  import("@/views/system/SysSetting.vue");
