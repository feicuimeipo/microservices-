    ...
    <div class="el-card__header">
      <div class="clearfix">
        ...
        <div style="float:right;">
          ...
          <el-button style="padding: 3px 0" type="text" @click="refresh" title="刷新">
            <i class="el-icon-refresh" style="font-weight:bold;"></i>
          </el-button>
          <el-button style="padding: 3px 0" type="text" @click="close" title="移除">
...
export default {
  name: "ht-column",
  components: { VRuntimeTemplate, eipChart, chart ,CustomDialogShowDetail},
  props: {
    columnAlias: {
      type: String,
      required: true
