            ...
            <el-collapse-item title="节点表单" name="2">
              ...
              >
                <el-card
                  ...
                  :key="node.nodeId"
                >
                  <FlowFormConfig :nodeId="node.nodeId" :nodeType="node.type" :title="node.name" :defId="defId" :defkey="topDefKey"/>
                </el-card>
              </el-scrollbar>
            </el-collapse-item>
            <el-collapse-item title="节点审批人员" name="3">
              ...
              >
                <el-card
                  ...
                  :key="node.nodeId"
                >
                  <FlowNodeUserConfig :nodeId="node.nodeId" :title="node.name" />
                </el-card>
              </el-scrollbar>
            </el-collapse-item>
            <el-collapse-item title="节点传阅人员" name="4">
              ...
              >
                <el-card
                  ...
                  :key="node.nodeId"
                >
                  <FlowNodeCopyToUserConfig :nodeId="node.nodeId" :title="node.name" />
                </el-card>
              </el-scrollbar>
            </el-collapse-item>
          ...
          <el-collapse v-model="activeNames" @change="handleChange" accordion>
            <el-collapse-item title="节点按钮" name="1">
              ...
              >
                ...
                >
                  <!-- 节点按钮配置 -->
                  <FlowNodeBtns ref="flowNodeBtns" :node="node" :defConfigData="defConfigData"></FlowNodeBtns>
                </el-card>
              </el-scrollbar>
            </el-collapse-item>
...
export default {
  ...
  methods: {
    ...
    saveDefSetting() {
      ...
      req
        .post(req.getContext().bpmModel + "/flow/node/v1/saveDefConf", param)
        .then(response => {
    ...
    init() {
      ...
      this.$store.dispatch("flow/getDefSetting", param).then(function(data) {
        ...
        let backgroundUrl =
          ...
          "/flow/def/v1/image?defId=" +
          this_.defId +
          "&bpmnInstId=&taskId=&rnd=" +
          rnd +
          "') no-repeat";
        let flowCanvasStyle = {
          position: "relative",
