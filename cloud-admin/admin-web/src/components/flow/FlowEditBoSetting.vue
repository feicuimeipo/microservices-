    ...
    <el-card class="bo-set__card" shadow="never">
      <div slot="header" class="flex" style="justify-content: space-between;">
        ...
        <div class="flex" style="width: 150px;justify-content: space-between;">
          <el-button size="mini" type="primary" icon="el-icon-check" @click="save(false)">保存</el-button>
          <el-button size="mini" type="warning" icon="el-icon-refresh" @click="reset">重置</el-button>
        </div>
      </div>
      <el-scrollbar class="scrollbar-fullheight">
        <table class="form-table bo-set__table" cellspacing="0" cellpadding="0" border="0">
          <tbody>
      ...
      <div style="width:100%;height: 550px;">
        ...
        <div style="width:73%;float: left;margin-left: 10px;height: 100%;">
          <table class="form-table" cellspacing="0" cellpadding="0" border="0">
            <tbody>
              <tr>
                ...
                <td>
                  <ht-input v-model="dataDialog.description" placeholder="请输入描述" autocomplete="off" :validate="{'required':true}"></ht-input>
                </td>
              </tr>
            </tbody>
          </table>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <eip-script-dialog
                          ...
                          append-to-body
                        />
                        <el-button @click="showDialog('beforeShowDialog')">常用脚本</el-button>
                        <!-- 可选变量对话框 -->
                        <FlowVarSelector :defId="defId" @node-click="varTreeBeforeShow" />
                        <br />
                        <br />
                        <ht-input
                          type="textarea"
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <eip-script-dialog
                          ...
                          append-to-body
                        />
                        <el-button @click="showDialog('whenSaveDialog')">常用脚本</el-button>
                        <!-- 可选变量对话框 -->
                        <FlowVarSelector :defId="defId" @node-click="varTreeWhenSave" />
                        <br />
                        <br />
                        <ht-input
                          type="textarea"
          ...
          <div slot="footer" class="dialog-footer" style="float: right;">
            <el-button type="primary" size="mini" @click="saveDataDialog" icon="el-icon-check">确 认</el-button>
...
export default {
  ...
  mounted() {
    ...
    req.get(url).then(function(data) {
      ...
      if (data.json.bodef) {
        data.json.bodef.boDefs.forEach(item => {
          let temp = {};
          temp.alias = item.key;
          temp.name = item.name;
