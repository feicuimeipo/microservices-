            ...
            >
              <thead>
                <tr>
                  ...
                  <th width="20%" v-if="pageParams.type !='2'">只读权限</th>
                  <th width="80%" v-if="pageParams.type =='2'">只读权限</th>
                  <th width="20%" v-if="pageParams.type !='2'">编辑权限</th>
                  <th width="20%" v-if="pageParams.type !='2'">必填权限</th>
                  <th width="20%" v-if="pageParams.type !='2'">是否隐藏</th>
                </tr>
                <tr>
                  ...
                  <td style="text-align: center" v-if="pageParams.type !='2'">
                ...
                <tr>
                  <th colspan="5">
                    <span style="float: left;">
                      ...
                      <span v-if="!table.main && table.ctrlType !='dataView'">子表</span>
...
export default {
  ...
  methods: {
    ...
    showDialog: function(param) {
      ...
      req
        .post(req.getContext().form + "/form/rights/v1/getPermission", param)
        .then(response => {
    ...
    saveAuth: function() {
      ...
      let this_ = this;
      req
        .post(req.getContext().form + "/form/rights/v1/save", param)
        .then(response => {
          let data = response.data;
          if (data.state) {
            this_.$message.success(data.message);
