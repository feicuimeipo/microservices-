  ...
  methods: {
    ...
    saveDataDialog() {
      const this_  = this;
        ...
        req.post(req.getContext().bpmModel +"/flow/node/v1/saveSub?defId="+this_.defId+"&nodeId="+this_.nodeId+"&parentDefKey="+this_.parentDefKey,this_.data).then(function(res){
          if(res.data.state){
    ...
    showDialog(){
        ...
        //获取子表表单字段变量
        req.post(req.getContext().bpmModel + "/flow/node/v1/varTree", {
            defId: this_.defId,
            nodeId: this_.nodeId,
        ...
        .then(function(respose) {
            ...
            //获取已编辑的子表权限设置
            req.get(req.getContext().bpmModel +"/flow/node/v1/initSub?defId="+this_.defId+"&nodeId="+this_.nodeId+"&parentDefKey="+this_.parentDefKey).then(function(data){
    ...
    clean(){
        ...
        this.$confirm("确定清除所有子表授权？","提示",
        {
          ...
          closeOnClickModal: false
            ...
            req.post(req.getContext().bpmModel +"/flow/node/v1/saveSub?defId="+this_.defId+"&nodeId="+this_.nodeId+"&parentDefKey="+this_.parentDefKey,{}).then(function(data){
              data = data.data;
              if (data.state) {
