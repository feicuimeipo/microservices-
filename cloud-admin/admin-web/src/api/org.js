...
export default {
  ...
  getOrg(param){
    return new Promise(((resolve, reject) => {
      req.get(uc+'/api/org/v1/org/getOrg?code='+param).then(response => {
        resolve(response.data)
      }),error => {
        reject(error)
      }
  ...
  getOrgPost(param){
    return new Promise((resolve, reject) => {
    req.get(uc+'/api/org/v1/orgPost/getOrgPost?postCode='+param).then(response => {
      resolve(response.data)
    }),error => {
      reject(error)
    }
  ...
  getOrgParamsByCode(param){
    return new Promise((resolve, reject) => {
      req.get(uc+'/api/org/v1/orgParam/getOrgParams?orgCode='+param).then(resp => {
        resolve(resp.data);
      }), error => {
        reject(error);
      }
