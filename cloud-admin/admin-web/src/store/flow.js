...
const mutations = {
    ...
    setDefSettingData(state, data){
        ...
        //如果驳回处理人模式为空，则默认选中“驳回节点配置人”
        for(let key in data.nodeSetData.bpmDefSetting.nodePropertieMap){
            if(data.nodeSetData.bpmDefSetting.nodePropertieMap[key].backUserMode==""){
                data.nodeSetData.bpmDefSetting.nodePropertieMap[key].backUserMode = "normal";
            }
        }
         //屏蔽一些多余的按钮配置
