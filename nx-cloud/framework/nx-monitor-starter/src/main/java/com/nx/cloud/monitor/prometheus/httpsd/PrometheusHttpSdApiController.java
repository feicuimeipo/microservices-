...
public class PrometheusHttpSdApiController {
	private final String activeProfile;
	private final DiscoveryClient discoveryClient;
	private final ApplicationEventPublisher eventPublisher;

	public PrometheusHttpSdApiController(String profile, DiscoveryClient discoveryClient, ApplicationEventPublisher eventPublisher) {
