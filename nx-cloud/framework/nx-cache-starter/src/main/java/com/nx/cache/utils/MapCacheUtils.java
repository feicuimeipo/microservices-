 ...
 * @date 2015年10月28日
 */
public class MapCacheUtils implements Closeable{
	...
	public MapCacheUtils(final long period, int maxSize) {
		this(period);
	 ...
	 *            检查过期间隔（毫秒）
	 */
	public MapCacheUtils(final long period) {
	...
	private class CacheKey implements Comparable<CacheKey>{
		...
		private MapCacheUtils getOuterType() {
			return MapCacheUtils.this;
		}
	...
	public static void main(String[] args) {
		final MapCacheUtils provider = new MapCacheUtils(100);
