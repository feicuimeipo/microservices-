...
public class RSA {
    ...
    public static PublicKey loadPublicKey(InputStream in) {
        try {
            ...
            byte[] bytes = Base64.decodeBase64Bytes(sb.toString());
    ...
    public static PublicKey loadPublicKey(String pubKeyString) {
        byte[] bytes = Base64.decodeBase64Bytes(pubKeyString);
        return loadPublicKey(bytes);
    }
    ...
    public static String encrypt(PublicKey key, String plainText) throws UnsupportedEncodingException {
