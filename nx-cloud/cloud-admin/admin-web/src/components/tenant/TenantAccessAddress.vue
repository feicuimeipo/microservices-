    ...
    >
      <el-form v-form class="copy-form">
        <ht-form-item label="管理端地址" label-width="120px">
          <ht-input v-model="manageUrl" readonly width="450px" />
          <el-button
            class="copy-btn"
            type="text"
        ...
        <ht-form-item label="用户端地址" label-width="120px">
          <ht-input v-model="frontUrl" readonly width="450px" />
          <el-button
            class="copy-btn"
            type="text"
        ...
        <ht-form-item label="移动端地址" label-width="120px">
          <ht-input v-model="mobileUrl" readonly width="450px" />
          <el-button
            class="copy-btn"
            type="text"
...
export default {
  ...
  methods: {
    showDialog(alias) {
      this.alias = alias;
      this.manageUrl = this.basicMUrl + "/mvue/login/" + alias;
      this.frontUrl = this.basicUrl + "/fvue/login/" + alias;
      this.mobileUrl = this.basicPUrl + "/mobilevue/login/" + alias;
