                ...
                <table class="form-table" cellspacing="0" cellpadding="0" border="0">
                  <tbody>
                    <tr>
                      ...
                      <th width="130px">日期类型:</th>
                      <td>
                        <ht-select
                          v-model="reminder.dateType"
                          :options="[{key:'caltime',value:'日历日'}]"
                        />
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <th width="130px" class="is-required">相对到期时间:</th>
                      <td colspan="3">
                        <ht-duration v-model="reminder.dueTime" validate="required" />
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <th width="130px">
                        <el-tooltip
                          class="item"
                          effect="dark"
                          content="return true,则执行该条催办；return talse,表示不执行该催办。如果表达式为空，将视为返回true。"
...
export default {
  name: "FlowNodeRemind",
  components: { MessageTypeSelector, eipScriptDialog },
  props: {
    //任务节点信息
    node: {
      type: Object,
