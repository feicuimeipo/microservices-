<template>
  <div>
    ...
    <!-- 审批区域显示 -->
    <div class="form-inline">
      <div class="control-label left-label">审批区域显示:</div>
      <ht-checkbox style="width: 55%;" :options="approvalArea" v-model="propertie.approvalArea" />
      <br />
    </div>
    <!-- 属性设置 -->
    <div class="form-inline">
      ...
      <div>
        <el-checkbox v-model="propertie.skipExecutorEmpty">执行人为空跳过</el-checkbox>
      ...
      <el-form v-form>
        ...
        <ht-form-item label="发送对象">
          ...
          <eip-bo-attr-selector
            ...
            :defId="defConfigData.curEditNode.defId"/><br>
