        ...
        <tbody>
          <tr>
            ...
            <th style="width: 150px;">
              <ht-input v-model="data.name" :disabled="!isEditabled" :validate="{'required':true}" />
            </th>
            <th style="width: 80px;">
              Key
              <span class="required">*</span>
            ...
            <el-card
                ...
                >
                  ...
                  <template v-for="(sub1,index) in sub.sub">
                    ...
                    <el-card
                      ...
                      />
                      <ht-input style="width: 25%;margin:0 3px;" v-model="sub1.judgeVal1" v-if="!['7','8'].includes(sub1.judgeCon1)"/>
                  ...
                  <template v-if="!sub.branch">
                    ...
                    />
                    <ht-input style="width: 25%;margin:0 3px;" v-model="sub.judgeVal1" v-if="!['7','8'].includes(sub.judgeCon1)"/>
              ...
              <template v-if="!condition.branch">
                ...
                <ht-select
                    ...
                    style="width: 25%;margin:0 3px;"
                />
                <ht-input style="width: 25%;margin:0 3px;" v-model="condition.judgeVal1" v-if="!['7','8'].includes(condition.judgeCon1)"/>
                <ht-select
