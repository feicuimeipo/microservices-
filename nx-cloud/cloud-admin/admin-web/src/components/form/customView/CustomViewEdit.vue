<template>
  ...
  >
    ...
    <el-tabs v-model="tabStatus">
      <el-tab-pane label="sql配置" name="sql">
        <el-form data-vv-scope="customViewEdit">
          <ht-form-item label="名称">
            <ht-input v-model="data.name" :validate="{required:true}" />
          </ht-form-item>
          <ht-form-item label="别名">
            <ht-input v-model="data.alias" :disabled="data.id?true:false" @change="changeAlias" name="dataAlias" :validate="{required:true}" v-pinyin="data.name"/>
          </ht-form-item>
          ...
          <ht-form-item label="sql语句">
            ...
            />
            &nbsp;&nbsp;<el-button type="primary" @click="checkSql" v-if="this.id===''">验证SQL</el-button>
          </ht-form-item>
        </el-form>
      </el-tab-pane>
        ...
        <el-table border :data="buttonDef" ref="table">
          <el-table-column label="名称">
            <template slot-scope="scope">
              <ht-input v-model="scope.row.name" :disabled="scope.row.isDefault==='1'" />
            </template>
          </el-table-column>
      ...
      <el-tab-pane label="字段设置" v-if="id!==''">
        <el-table :data="data.metafields" border>
          ...
          <el-table-column label="实际列名">
            <template slot-scope="scope">
              <ht-input v-model="scope.row.fieldName" />
            </template>
          </el-table-column>
          <el-table-column label="描述">
            <template slot-scope="scope">
              <ht-input v-model="scope.row.fieldDesc" />
            </template>
          </el-table-column>
          <el-tooltip class="item" effect="dark" content="Top Right 提示文字" placement="top-end">
            <el-table-column width="150">
              ...
              <template slot-scope="scope">
                <ht-input v-model="scope.row.width" />
              </template>
            </el-table-column>
          </el-tooltip>
