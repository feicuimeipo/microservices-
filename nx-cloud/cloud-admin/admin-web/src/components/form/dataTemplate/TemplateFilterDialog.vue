      ...
      <table class="form-table" cellspacing="0" cellpadding="0" border="0">
        <tbody>
          <tr>
            ...
            <th width="10%">名称：</th>
            <td width="23%">
              <ht-input v-model="filter.name" :disabled="!isEditabled" :validate="{required:true}"></ht-input>
            </td>
            <th width="10%">Key：</th>
            <td width="23%">
              <ht-input
              ...
              <table class="form-table" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <ht-select
                        v-model="filter.loginUserField"
                        :options="sqlOption.options"
                        clearable
                      />
                    </td>
                    <td>等于</td>
                  ...
                  <tr>
                    <td>
                      <ht-select
                        v-model="filter.loginUserOrgsField"
                        :options="sqlOption.options"
                        clearable
                      />
                    </td>
                    ...
                    <td>
                      <el-checkbox
                        v-model="filter.loginUserOrgs"
                        true-label="1"
                        false-label="0"
                      >当前登陆用户所属组织的ID</el-checkbox>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <ht-select
                        v-model="filter.loginUserSubOrgsField"
                        :options="sqlOption.options"
                        clearable
                      />
                    </td>
                    ...
                    <td>
                      <el-checkbox
                        v-model="filter.loginUserSubOrgs"
                        true-label="1"
                        false-label="0"
...
export default {
  ...
  methods: {
    ...
    changeFilterType() {
      if (
        (this.filter.filterType == 2 || this.filter.filterType == 3) &&
        this.filter.filterType != this.editFilter.type
      ) {
        this.filter.filter = " ";
        this.codemirror.setValue(" ");
    ...
    getPermissionData() {
      ...
      if (
        this.filter.loginUserSubOrgs &&
        this.filter.loginUserSubOrgs !== "0"
      ) {
