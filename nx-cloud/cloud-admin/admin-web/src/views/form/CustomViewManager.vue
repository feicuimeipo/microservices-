<template>
  <div class="fullheight">
    ...
    >
      <template v-slot:toolbar>
        <el-button-group>
          ...
          <ht-delete-button :url="deleteUrl" :htTable="$refs.table">删除</ht-delete-button>
        </el-button-group>
      </template>
    ...
    <custom-view-edit :id="selectedId" ref="customChartEdit" @after-save="afterSave" />
    <el-dialog title="上传文件" :visible="dialogVisible" :before-close="beforeClose" width="40%">
