  ...
  <div class="fullheight">
    <el-form v-form data-vv-scope="tenantMailServerForm">
        ...
        <ht-form-item label="协议服务器" label-width="180px">
          <ht-input v-model="tenantMailServer.mailHost" autocomplete="off" validate="required" />
        </ht-form-item>
        <ht-form-item label="密码" label-width="180px">
          <ht-input v-model="tenantMailServer.mailPass" show-password autocomplete="off" validate="required" />
        </ht-form-item>
        <ht-form-item label="昵称" label-width="180px">
          <ht-input v-model="tenantMailServer.nickName" validate="required" />
        </ht-form-item>
        <ht-form-item label="邮箱地址" label-width="180px">
          <ht-input v-model="tenantMailServer.userName" validate="required" />
        </ht-form-item>
