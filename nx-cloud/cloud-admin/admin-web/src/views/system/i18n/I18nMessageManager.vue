          ...
          <template v-slot:toolbar>
            <el-button-group>
              ...
              <el-button
                  ...
                  @click="showDialog('init')"
              >初始化</el-button>
              <el-button
                  size="small"
                  icon="el-icon-error"
                  @click="showDialog('clearAll')"
              >清除缓存</el-button>
            </el-button-group>
                ...
                <tr>
                  ...
                  <td class="i18nMessage-input-width">
                    <ht-input
                      ...
                      autocomplete="off"
                      :validate="{required:true,regex:{exp:'^[a-zA-Z][a-zA-Z0-9._-]*$',message:'只能输入字母、数字、下划线和点，且以字母开头'}}"
    ...
    showDialog(command, row) {
      switch (command) {
        ...
        case "edit":
          ...
          this.loadDataUrl =
            "/i18n/custom/i18nMessage/v1/getI18nMessageJson?key=" + row.key_;
          this.dialogVisible = true;
