    ...
    <el-container v-if="editMenuFormVisible">
      <el-header>
        <ht-submit-button
          ...
          v-if=" !menu.id || $store.state.login.currentUser.userAttrs.tenantId == menu.tenantId"
        ...
        <el-form data-vv-scope="editMenuForm" :model="menu" size="mini" :inline="true">
          ...
          <ht-form-item v-if="!isHref" label="别名" label-width="150px">
            <ht-input
              ...
              autocomplete="off"
              style="width:400px"
              :validate="'required|alpha_num|isExist:${portal}/sys/sysMenu/v1/isMenuExistByAlias?alias=,'+menu.alias"
            ></ht-input>
          </ht-form-item>
