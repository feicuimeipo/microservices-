      ...
      <el-form v-model="curRow" data-vv-scope="editForm">
        ...
        <ht-form-item label="保存时间" prop="receivers" label-width="80px">
          <ht-radio
            ...
            :options="[{ key: 7, value: '一周(7天)'}, { key: 30, value: '一个月(30天)' }, { key: 90, value: '三个月(90天)' }, { key: 180, value: '半年(180天)' }, { key: 365, value: '一年(365天)' }]"
          />
        </ht-form-item>
...
export default {
  ...
  methods: {
    ...
    loadData(param, cb) {
      req
        .post(req.getContext().portal + "/sys/sysLogsSettings/v1/list", param)
        .then(data => {
