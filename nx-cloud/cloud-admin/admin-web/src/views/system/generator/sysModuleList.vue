<template>
  <el-container style="outline: 1px solid #e7eaec">
    <ht-aside-tree
      cat-id="10"
      :hasFooter="false"
    ...
    <el-main style="padding: 0">
      <el-container class="fullheight" style="margin: 10px 10px 10px 20px">
            ...
            <el-card shadow="hover" :body-style="{ padding: '0px' }">
              ...
              <div class="card-item-actions">
                <ul>
                  ...
                  <li class="el-icon-paperclip" @click="modulePush(item.id)">
                    <span>发布</span>
                  </li>
        ...
        <!-- 发布菜单 -->
        <sysModuleAddMenus ref="sysModuleAddMenus"></sysModuleAddMenus>
      </el-container>
    </el-main>
  </el-container>
</template>
...
export default {
  ...
  methods: {
    ...
    modulePush(id) {
      this.$refs.sysModuleAddMenus.showDialog(id);
    },
