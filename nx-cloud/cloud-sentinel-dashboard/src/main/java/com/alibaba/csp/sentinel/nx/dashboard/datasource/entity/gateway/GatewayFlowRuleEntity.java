...
package com.alibaba.csp.sentinel.nx.dashboard.datasource.entity.gateway;

import com.alibaba.csp.sentinel.adapter.gateway.common.rule.GatewayFlowRule;
import com.alibaba.csp.sentinel.adapter.gateway.common.rule.GatewayParamFlowItem;
import com.alibaba.csp.sentinel.dashboard.datasource.entity.gateway.GatewayParamFlowItemEntity;
import com.alibaba.csp.sentinel.dashboard.datasource.entity.rule.RuleEntity;
import com.alibaba.csp.sentinel.nx.dashboard.util.JSONUtils;
...
public class GatewayFlowRuleEntity implements RuleEntity {
    ...
    @Override
    public Rule toRule() {
        GatewayFlowRule gatewayFlowRule = this.toGatewayFlowRule();
        return new Rule() {
            @Override
            public String getResource() {
                if (gatewayFlowRule!=null){
                    return JSONUtils.toJSONString(gatewayFlowRule);
                }
                return null;
            }
        };
