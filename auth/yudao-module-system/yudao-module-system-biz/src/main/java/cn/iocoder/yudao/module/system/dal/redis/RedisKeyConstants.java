...
public interface RedisKeyConstants {
    ...
    RedisKeyDefine INTERNATIONAL = new RedisKeyDefine("international state", // 注意，它是被 JustAuth 的 justauth.type.prefix 使用到
            "international:%s", // 参数为 state
            STRING, String.class, Duration.ofHours(24)); // 值为 state

    RedisKeyDefine DataLang = new RedisKeyDefine("DataLang", // 注意，它是被 JustAuth 的 justauth.type.prefix 使用到
            "dataLang:%s", // 参数为 state
            STRING, String.class, Duration.ofHours(24)); // 值为 state
